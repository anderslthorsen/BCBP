...
%nii_setOrigin12({T1,fn}, 1, false);
             
%%
matlabbatch{1}.cfg_basicio.file_dir.dir_ops.cfg_cd.dir = {subject_dir};
%%
matlabbatch{2}.spm.stats.fmri_spec.dir = {strcat(subject_dir,'\1st_level')};
matlabbatch{2}.spm.stats.fmri_spec.timing.units = 'secs';
matlabbatch{2}.spm.stats.fmri_spec.timing.RT = 2.1;
...
matlabbatch{2}.spm.stats.fmri_spec.sess.multi = {onset_file};
matlabbatch{2}.spm.stats.fmri_spec.sess.regress = struct('name', {}, 'val', {});
matlabbatch{2}.spm.stats.fmri_spec.sess.multi_reg(1) = {movement_file};
...
matlabbatch{3}.spm.stats.fmri_est.spmmat(1) = cfg_dep('fMRI model specification: SPM.mat File', substruct('.','val', '{}',{7}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
matlabbatch{3}.spm.stats.fmri_est.write_residuals = 0;
matlabbatch{3}.spm.stats.fmri_est.method.Classical = 1;
matlabbatch{4}.spm.stats.con.spmmat(1) = cfg_dep('Model estimation: SPM.mat File', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
matlabbatch{4}.spm.stats.con.consess{1}.tcon.name = 'SucGo';
matlabbatch{4}.spm.stats.con.consess{1}.tcon.weights = 1;
matlabbatch{4}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{4}.spm.stats.con.consess{2}.tcon.name = 'SucStop';
matlabbatch{4}.spm.stats.con.consess{2}.tcon.weights = [0 1];
matlabbatch{4}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
matlabbatch{4}.spm.stats.con.consess{3}.tcon.name = 'FailStop';
matlabbatch{4}.spm.stats.con.consess{3}.tcon.weights = [0 0 1];
matlabbatch{4}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
matlabbatch{4}.spm.stats.con.consess{4}.tcon.name = 'SucStop > SucGo';
matlabbatch{4}.spm.stats.con.consess{4}.tcon.weights = [-1 1];
matlabbatch{4}.spm.stats.con.consess{4}.tcon.sessrep = 'none';
matlabbatch{4}.spm.stats.con.consess{5}.tcon.name = 'SucGo < SucStop';
matlabbatch{4}.spm.stats.con.consess{5}.tcon.weights = [1 -1];
matlabbatch{4}.spm.stats.con.consess{5}.tcon.sessrep = 'none';
matlabbatch{4}.spm.stats.con.consess{6}.tcon.name = 'FailStop < SucGo';
matlabbatch{4}.spm.stats.con.consess{6}.tcon.weights = [-1 0 1];
matlabbatch{4}.spm.stats.con.consess{6}.tcon.sessrep = 'none';
matlabbatch{4}.spm.stats.con.consess{7}.tcon.name = 'SucStop < FailStop';
matlabbatch{4}.spm.stats.con.consess{7}.tcon.weights = [0 1 -1];
matlabbatch{4}.spm.stats.con.consess{7}.tcon.sessrep = 'none';
matlabbatch{4}.spm.stats.con.consess{8}.tcon.name = 'FailStop < SucStop';
matlabbatch{4}.spm.stats.con.consess{8}.tcon.weights = [0 -1 1];
