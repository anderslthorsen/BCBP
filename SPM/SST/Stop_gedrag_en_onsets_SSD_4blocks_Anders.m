...
inputdir='\\ihelse.net\Forskning\HBE\2015-00936\Data_analysis\SST\behavioral_data\xls\'
outputdir='\\ihelse.net\Forskning\HBE\2015-00936\Data_analysis\SST\behavioral_data\output\'

% Bergen first test
subjects{3}.stop=[1];

% Bergen T0
subjects{4}.stop=[1 3 4 5 6 7 8 9 10  ...
...
for S=[6]
    ...
    for x = subjects{1,S}.stop
        ...
        if x < 10
            fn = strcat(inputdir,'SST_0000', num2str(x),timepoint,'.xls');
        elseif x < 100
            fn = strcat(inputdir,'SST_000', num2str(x),timepoint,'.xls');
        else
        ...
        colname = {'imgGo.OnsetTime', 'imgFixation.OnsetTime', 'StopStim', 'ACC', 'InLine.Trigger', ...
